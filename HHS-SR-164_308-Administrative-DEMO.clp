...
;;; ============================================================
;;; HHS-SR-164_308-Administrative-DEMO.clp
;;; HIPAA Security Rule Risk Assessment (SCA) Expert System
;;; Administrative Safeguards | Controls ADM-01 through ADM-08
;;; 45 CFR Part 164.308 Security Rule | HHS RIN 0945-AA22 NPRM
...
;;;   Limited to first 8 controls (ADM-01 through ADM-08).
;;;   For evaluation purposes only.
;;;   Full version: HHS-SR-164_308-Administrative.clp

;;; Current Version: 1.0.20
;;; Full version history archived separately in: HHS-SR-164_308-Administrative-DEMO-CHANGELOG.txt
;;; ============================================================
...
(deftemplate assessment-state
  ...
  (slot save-file   (type STRING)  (default "SCA-308-DEMO-Answers.txt"))
...
;;; ---------- QUESTION DATA ----------
;;; (qdata <num> <id> <cfr-section> <standard> <question-text>
;;;        <compliant-answers> <partial-answer> <partial-weight> <full-weight>
;;;        <finding-compliant> <finding-partial> <finding-gap>
;;;        <finding-noncompliant>
;;;        <rem-compliant-plain> <rem-compliant-technical>
;;;        <rem-partial-plain>   <rem-partial-technical>
;;;        <rem-noncompliant-plain> <rem-noncompliant-technical>
;;;        <ref-name> <ref-security-control> <ref-sections> <ref-pages>)
;;; N/DNA/U always yield weight 0.0 and finding-noncompliant.
;;; NOTE: Semicolons within question strings are stored as U+FF1B (fullwidth
;;;       semicolon) to avoid CLIPS treating them as comment delimiters.
(deffacts question-data
  (qdata   1 "ADM-01" "164.308 (ii)(A) [Inventory]" "Technology Asset Inventory"
    "Has your organization developed a written inventory of your technology assets that contains the identification, version, person accountable, and location of each technology asset?"
    "Y|ALT" "P" 0.5 1.0
    "Compliant" "Partial Compliance" "Requirement: Inventory" "" "Non-compliant"
    "Maintain control(s).  Modify/update as needed." ""
    "Review your existing inventory and add any missing required elements: identification, version, person accountable, and location. Assign one person to own and maintain the inventory on a defined review cycle." "Complete the inventory by documenting all missing required elements per CM-8. Assign a designated owner per CM-8(4) and establish a formal update process per CM-8(1)."
    "Create a written list of all technology assets. For each, record: name/ID, version, person responsible, and physical location. Assign one owner and establish a process to add or remove assets as they change." "Develop and document a system component inventory per CM-8 capturing identification, version, person accountable, and location. Assign ownership per CM-8(4) and update upon installation or removal per CM-8(1)."
    "NIST SP 800-53r5" "Configuration Management (CM)" "CM-8, CM-8(1), CM-8(4)" "107, 108"
    "NPRM" "A new standard proposed by the NPRM")
  (qdata   2 "ADM-02" "164.308 (ii)(B) [Network Map]" "Technology Asset Inventory"
    "Has your organization developed a network map that illustrates the movement of electronic protected health information throughout your electronic information systems, including but not limited to, how electronic protected health enters and exits such information systems, and is accessed from  outside of such information systems?"
    "Y|ALT" "P" 0.5 1.0
    "Compliant" "Partial Compliance" "Requirement: Network Map" "" "Non-compliant"
    "Maintain control(s).  Modify/update as needed." ""
    "Update your network map to ensure it fully illustrates all pathways where ePHI moves through your systems. Include all systems, connections, and data flows not yet documented." "Complete the network map per CM-12 to reflect all ePHI data flows. Ensure it accurately represents the system architecture per CM-8 and aligns with your system security plan per PL-8."
    "Create a written network map showing how ePHI moves through all your electronic information systems. Include all systems, connections, and data flows. Assign an owner and keep it current." "Develop a network map per CM-12 that illustrates all ePHI movement across relevant electronic information systems. Align with system component inventory per CM-8 and system security plan per PL-8."
    "NIST SP 800-53r5" "Configuration Management (CM)" "CM-8, CM-12, PL-8" "107, 112, 193"
    "NPRM" "A new standard proposed by the NPRM")
  (qdata   3 "ADM-03" "164.308 (a)(1)(ii)(C)(1)  [Maintenance]" "Technology Asset Inventory"
    "On an ongoing basis, but at least once every 12 months, does your organization review and update your written 'Technology Asset Inventory'?"
    "Y|ALT" "P" 0.5 1.0
    "Compliant" "Partial Compliance" "Requirement: Maintenance" "" "Non-compliant"
    "Maintain control(s).  Modify/update as needed." ""
    "Establish a documented annual review cycle for your technology asset inventory. Assign responsibility for completing and recording the review each year." "Formalize the annual review process for the asset inventory per CM-8(2). Document review results and update the inventory to reflect current system state per CM-8(1)."
    "Establish a process to review and update your technology asset inventory at least once every 12 months. Document who is responsible, when reviews occur, and what was updated." "Implement a formal annual review and update process for the system component inventory per CM-8(2). Assign responsibility and document all updates made during each review per CM-8."
    "NIST SP 800-53r5" "Configuration Management (CM)" "CM-8(1), CM-8(2)" "108"
    "NPRM" "A new standard proposed by the NPRM")
  (qdata   4 "ADM-04" "164.308 (a)(1)(ii)(C)(2)  [Maintenance]" "Technology Asset Inventory"
    "Does your organization perform maintenance to its 'Technology Asset Inventory' when there is a change in your environment or operations that may affect electronic protected health information, including but not limited to the adoption of new technology assets; the upgrading, updating, or patching of technology assets; newly recognized threats to the confidentiality, integrity, or availability of electronic protected health information; a sale, transfer, merger, or consolidation of all or part of your organization; a security incident that affects the confidentiality, integrity, and availability of electronic protected health information; and/or relevant changes in Federal, State, Tribal, or territorial law?"
    "Y|ALT" "P" 0.5 1.0
    "Compliant" "Partial Compliance" "Requirement: Maintenance" "" "Non-compliant"
    "Maintain control(s).  Modify/update as needed." ""
    "Update your inventory maintenance process to ensure changes to your environment trigger timely inventory updates. Document the trigger events and who is responsible for updates." "Strengthen inventory maintenance triggers per CM-8(1) to ensure updates occur upon any environmental change. Integrate with your configuration management process per CM-3."
    "Establish a process to update your technology asset inventory whenever your environment changes (new assets, removed assets, location changes). Document the process and assign responsibility." "Implement event-driven inventory updates per CM-8(1) to maintain accuracy when environment changes occur. Integrate with configuration change control per CM-3."
    "NIST SP 800-53r5" "Configuration Management (CM)" "CM-8(1), CM-8(2)" "108"
    "NPRM" "A new standard proposed by the NPRM")
  (qdata   5 "ADM-05" "164.308 (ii)(A)(1) [Assessment]" "Risk Analysis"
    "Does your organization perform or conduct a review of the technology asset inventory and the network map to identify where electronic protected health information may be created, received, maintained, or transmitted within your electronic information systems?"
    "Y|ALT" "P" 0.5 1.0
    "Compliant" "Partial Compliance" "Requirement: Assessment" "" "Non-compliant"
    "Maintain control(s).  Modify/update as needed." ""
    "Complete your review of the asset inventory and network map to identify all locations where ePHI is created, received, maintained, or transmitted. Document any gaps identified." "Expand the risk assessment scope per RA-3 to cover all ePHI locations identified in the asset inventory (CM-8) and network map. Document all identified ePHI flows."
    "Review your technology asset inventory and network map to identify every location where ePHI is created, received, maintained, or transmitted. Document all findings as the foundation of your risk analysis." "Conduct a scope assessment per RA-3(1) using the system component inventory (CM-8) and network map to identify all ePHI locations as the basis for risk analysis."
    "NIST SP 800-53r5" "Risk Assessment (RA)" "RA-3, RA-3(1)" "256, 257"
    "SR-RE" "A REQUIRED standard in the current Security Rule but enhanced by the NPRM")
  (qdata   6 "ADM-06" "164.308 (ii)(A)(2)  [Assessment]" "Risk Analysis"
    "Does your organization identify all reasonably anticipated threats to the confidentiality, integrity, and availability of electronic protected health information that your organization creates, receives, maintains, or transmits?"
    "Y|ALT" "P" 0.5 1.0
    "Compliant" "Partial Compliance" "Requirement: Assessment" "" "Non-compliant"
    "Maintain control(s).  Modify/update as needed." ""
    "Expand your threat identification to ensure all reasonably anticipated threats to ePHI confidentiality, integrity, and availability are documented. Review and supplement existing threat listings." "Complete threat identification per RA-3 to cover all reasonably anticipated threats to ePHI CIA. Reference threat catalogues and supplement with environment-specific threats."
    "Identify and document all reasonably anticipated threats to the confidentiality, integrity, and availability of your ePHI. Include natural, human, and environmental threat sources." "Conduct and document threat identification per RA-3 covering all reasonably anticipated threats to ePHI CIA, including threat sources and threat events per RA-3(1)."
    "NIST SP 800-53r5" "Risk Assessment (RA)" "RA-3, RA-3(1)" "256, 257"
    "SR-RE" "A REQUIRED standard in the current Security Rule but enhanced by the NPRM")
  (qdata   7 "ADM-07" "164.308 (ii)(A)(3)  [Assessment]" "Risk Analysis"
    "Does your organization identify potential vulnerabilities and predisposing conditions to your relevant electronic information systems?"
    "Y|ALT" "P" 0.5 1.0
    "Compliant" "Partial Compliance" "Requirement: Assessment" "" "Non-compliant"
    "Maintain control(s).  Modify/update as needed." ""
    "Review and expand your vulnerability identification to ensure all potential weaknesses and predisposing conditions in your ePHI systems are documented." "Expand vulnerability identification per RA-3 and RA-5 to cover all predisposing conditions and weaknesses in relevant electronic information systems."
    "Identify and document all potential vulnerabilities and predisposing conditions in your electronic information systems that could be exploited by identified threats." "Conduct and document vulnerability identification per RA-3 and RA-5 covering system weaknesses and predisposing conditions across all relevant electronic information systems."
    "NIST SP 800-53r5" "Risk Assessment (RA)" "RA-3, RA-5" "256, 259"
    "SR-RE" "A REQUIRED standard in the current Security Rule but enhanced by the NPRM")
  (qdata   8 "ADM-08" "164.308 (ii)(A)(4)  [Assessment]" "Risk Analysis"
    "Does your organization perform an assessment (including documentation) of the security measures you use to ensure the confidentiality, integrity, and availability of the electronic protected health information created, received, maintained, or transmitted by your organization?"
    "Y|ALT" "P" 0.5 1.0
    "Compliant" "Partial Compliance" "Requirement: Assessment" "" "Non-compliant"
    "Maintain control(s).  Modify/update as needed." ""
    "Complete your assessment of existing security measures to ensure all controls protecting ePHI CIA are evaluated and documented." "Expand security measure assessment per RA-3 to evaluate all controls protecting ePHI CIA. Align assessment procedures with CA-2 to ensure completeness."
    "Assess and document all security measures currently in place to protect the confidentiality, integrity, and availability of your ePHI. Include both technical and administrative controls." "Perform and document a control assessment per CA-2 to evaluate all security measures protecting ePHI CIA. Integrate findings into risk assessment per RA-3."
    "NIST SP 800-53r5" "Risk Assessment (RA), Assessment, Authorization, and Monitoring (CA)" "RA-3, CA-2" "256, 96"
    "SR-RE" "A REQUIRED standard in the current Security Rule but enhanced by the NPRM")
)
        ...
        then
          ...
          (if (eq ?format "H")
            then
              ...
              (printout report-file "<p><em>Administrative Safeguards &mdash; ADM-01 to ADM-08</em></p>" crlf)
          )
          report-file
      )
  )
...
(deffunction save-answers (?filename)
  ...
  (if (or (not ?fh) (eq ?fh FALSE))
    then
      ...
      (printout answer-file ";;; Generated by HHS-SR-164_308-Administrative-DEMO.clp" crlf)
...
(deffunction load-answer-line (?line)
  "Parses a line of the form ADM-NN=ANS and returns a multifield (id ans) or FALSE."
...
(defrule show-banner
  ...
  (printout t "  Administrative Safeguards  |  Controls ADM-01 to ADM-08"    crlf)
  (printout t "  45 CFR Part 164 Security Rule  |  HHS RIN 0945-AA22 NPRM"   crlf)
  (printout t "  ------------------------------------------------------------" crlf)
  ...
  (printout t "  ============================================================" crlf)
  (printout t crlf)
  (printout t "  ABOUT ADMINISTRATIVE SAFEGUARDS" crlf)
  (printout t "  ===============================" crlf)
  ...
  (if (neq ?fmt-str "N")
    then
      ...
      (printout t "       Example: C:\Users\YourName\Documents\SCA-308-DEMO-Report" ?ext crlf)
      (printout t crlf)
      (printout t "  Press ENTER to save in the CLIPS program folder"              crlf)
      (printout t "  as SCA-308-DEMO-Report" ?ext "." crlf)
      (printout t crlf)
      (printout t "  Enter path or press ENTER: ")
      (bind ?rpt-input (readline))
      (printout t crlf)
      (if (eq ?rpt-input "")
        then (bind ?rpt-path (str-cat "SCA-308-DEMO-Report" ?ext))
  ...
  (printout t "       Example: C:\Users\YourName\Documents\SCA-308-DEMO-Answers.txt"  crlf)
  (printout t crlf)
  (printout t "  Press ENTER to save in the CLIPS program folder"               crlf)
  (printout t "  (SCA-308-DEMO-Answers.txt in the folder where CLIPS.exe is located)."   crlf)
  (printout t crlf)
  (printout t "  Enter path or press ENTER: ")
  (bind ?path-input (readline))
  (printout t crlf)
  (if (eq ?path-input "")
    then (bind ?save-path "SCA-308-DEMO-Answers.txt")
...
(defrule generate-report
  ...
  (tee-line ?rpt-fh ?rpt-fmt "  Administrative Safeguards  |  Controls ADM-01 to ADM-08")
  (tee-line ?rpt-fh ?rpt-fmt "  45 CFR Part 164 Security Rule  |  HHS RIN 0945-AA22 NPRM")
  (tee-line ?rpt-fh ?rpt-fmt "  ------------------------------------------------------------")
  ...
  (tee-line ?rpt-fh ?rpt-fmt "  ============================================================")
  (tee-blank ?rpt-fh ?rpt-fmt)
  (tee-line ?rpt-fh ?rpt-fmt "  ABOUT ADMINISTRATIVE SAFEGUARDS")
  (tee-line ?rpt-fh ?rpt-fmt "  ===============================")
  ...
  (tee-line ?rpt-fh ?rpt-fmt "  Administrative Safeguards  |  ADM-01 to ADM-08")
  (tee-line ?rpt-fh ?rpt-fmt "  ============================================================")
  (tee-blank ?rpt-fh ?rpt-fmt)
  ...
  (if (eq ?save-path "") then (bind ?save-path "SCA-308-DEMO-Answers.txt"))
  ...
  (if (eq ?ctrl-input "")
    then
      ...
      (if ?revised then
        ...
        (if (eq ?rev-path "") then (bind ?rev-path "SCA-308-DEMO-Answers.txt"))
      ...
      (if (not ?found)
        then
          ...
          (printout t "  Please enter a valid ID (ADM-01 through ADM-08)." crlf)
          (printout t crlf)
...
;;; End of HHS-SR-164_308-Administrative-DEMO.clp
